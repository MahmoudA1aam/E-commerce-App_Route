...
import '../../../../data/model_dto/tabs_model_dto/home_tab_model_dto/CategoryOrBrandModelDto.dart';
...
class GetResponseFromCartEntity {
  GetResponseFromCartEntity(
      {this.status, this.numOfCartItems, this.data, this.message});

  String? status;
  int? numOfCartItems;
  GetDataResponseCartEntity? data;
  String? message;
}
...
class GetDataResponseCartEntity {
  GetDataResponseCartEntity({
    this.id,
    this.cartOwner,
    this.products,
    this.createdAt,
  ...
  String? id;
  String? cartOwner;
  List<GetProductsResponseCartEntity>? products;
  String? createdAt;
  String? updatedAt;
  int? v;
  int? totalCartPrice;
...
class GetProductsResponseCartEntity {
  GetProductsResponseCartEntity({
    this.count,
    this.id,
    this.product,
    this.price,
...
class ProductCartEntity {
  ...
  int? quantity;
  String? imageCover;
  DataOfCategoryOrBrandDto? category;
  DataOfCategoryOrBrandDto? brand;
  num? ratingsAverage;
}
