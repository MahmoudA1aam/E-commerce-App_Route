...
class CategoryOrBrandEntityModel {
  CategoryOrBrandEntityModel({
    this.results,
    this.data,
  });
  ...
  List<DataOfCategoryOrBrandEntity>? data;
}
...
class DataOfCategoryOrBrandEntity {
  DataOfCategoryOrBrandEntity({
    this.id,
    this.name,
    this.slug,
    this.image,
